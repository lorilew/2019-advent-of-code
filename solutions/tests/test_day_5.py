...
from solutions.day_5 import read_instruction, handle_opcode_01, handle_opcode_02, handle_opcode_03, handle_opcode_04, \
    handle_opcode_05, handle_opcode_06, handle_opcode_07, handle_opcode_08, intcode_computer
...
class Day5TestCase(unittest.TestCase):
    ...
    def test_intcode_computer_input_less_than_8(self):
        data = '3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,1' \
